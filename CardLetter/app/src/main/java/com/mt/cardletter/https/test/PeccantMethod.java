...
public class PeccantMethod {
//    public static final String BASE_URL = "http://42.159.202.20:8881";
    /**
     * 测试版地址
     */
    public static final String BASE_URL = "http://ddycapi.market.alicloudapi.com";
    private static Retrofit retrofit;

    private PeccantMethod() {
    ...
    private PeccantMethod(String base_url) {
        retrofit = new Retrofit.Builder()
                .client(genericClient())
                .addConverterFactory(GsonConverterFactory.create())
                .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
    ...
    private static class SingletonHolder {
        private static final PeccantMethod INSTANCE = new PeccantMethod();
    }

    //获取单例
    public static PeccantMethod getInstance() {
        return SingletonHolder.INSTANCE;
    }
    public static PeccantMethod getInstance(String base_url) {
        return new PeccantMethod(base_url);
    }
...
//                        if (Constant.TOKEN == null || Constant.TOKEN.equals("")) {
                            request = chain.request().newBuilder()
                                    .addHeader("Authorization","APPCODE 4be7846862f141bab64b37897447ea56")
                                    .build();
//                        } else {
