...
public class JTAdapter extends BaseAdapter {
    ...
    private List<BankEntity.BankBean.JtListBean> list;

    public JTAdapter(Context context, List<BankEntity.BankBean.JtListBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final BankEntity.BankBean.JtListBean bean= list.get(position);
        if (convertView==null){
