...
public class GDAdapter extends BaseAdapter {
    ...
    private List<BankEntity.BankBean.GdListBean> list;

    public GDAdapter(Context context, List<BankEntity.BankBean.GdListBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final BankEntity.BankBean.GdListBean bean= list.get(position);
        if (convertView==null){
