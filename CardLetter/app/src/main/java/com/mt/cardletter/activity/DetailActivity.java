...
import com.mt.cardletter.view.exchange.DetailAdapter;
import com.mt.cardletter.view.exchange.DetailHeaderBehavior;
...
import static com.mt.cardletter.activity.GoodActivity.CLEARCAR_ACTION;
...
public class DetailActivity extends GoodsBaseActivity implements AddWidget.OnAddClick{
    ...
    private void initShopCar() {
        ...
        flist.addAll(GoodActivity.carAdapter.getData());
    ...
    private void dealCar(FoodBean foodBean) {
        ...
        Intent intent = new Intent(GoodActivity.CAR_ACTION);
