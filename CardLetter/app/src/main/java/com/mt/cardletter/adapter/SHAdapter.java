...
public class SHAdapter extends BaseAdapter {
    ...
    private List<BankEntity.BankBean.ShListBean> list;

    public SHAdapter(Context context, List<BankEntity.BankBean.ShListBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final BankEntity.BankBean.ShListBean bean= list.get(position);
        if (convertView==null){
