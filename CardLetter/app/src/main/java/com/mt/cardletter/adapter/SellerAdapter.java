...
public class SellerAdapter extends RecyclerView.Adapter<SellerAdapter.ViewHolder> {
    ...
    private List<SellerEntity.DataBeanX.DataBean> list;
    ...
    public void addData(List<SellerEntity.DataBeanX.DataBean> list){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final SellerEntity.DataBeanX.DataBean bean = list.get(position);
