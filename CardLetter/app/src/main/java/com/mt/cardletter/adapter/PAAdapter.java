...
public class PAAdapter extends BaseAdapter {
    ...
    private List<BankEntity.BankBean.PaListBean> list;

    public PAAdapter(Context context, List<BankEntity.BankBean.PaListBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final BankEntity.BankBean.PaListBean bean= list.get(position);
        if (convertView==null){
